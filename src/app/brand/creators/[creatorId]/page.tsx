    ...
    <main className="min-h-screen bg-zinc-950 text-zinc-50">
      <div className="mx-auto max-w-5xl space-y-8 px-4 py-12">
        <section className="space-y-4 rounded-xl border border-zinc-800 bg-zinc-900/70 px-6 py-5">
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <Button asChild variant="outline" size="sm">
              <Link href="/brand/briefs">Back to Briefs</Link>
            </Button>
          </div>
        ...
        <section className="grid gap-3 sm:grid-cols-3">
          <article className="rounded-xl border border-zinc-800 bg-zinc-900/70 px-4 py-3">
          ...
          {creator.bidsAsCreator.length === 0 ? (
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {creator.bidsAsCreator.map((bid) => (
                <article key={bid.id} className="rounded-xl border border-zinc-800 bg-zinc-900/70 px-4 py-3">
